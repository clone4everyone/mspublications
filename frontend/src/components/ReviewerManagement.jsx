    ...
    <>
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h3 className="flex gap-1 text-gray-500 items-center hover:text-gray-600 cursor-pointer" onClick={() => navigate('/IJPPI/editor/journal/pharma')}>
              <FaArrowLeft/>
              <span className="text-xl font-bold text-gray-500 tracking-tight flex gap-1 items-center hover:text-gray-600 cursor-pointer">Back To Dashboard</span>
            </h3>
          </div>
          <div>
                  ...
                  <div className="flex-1">
                    ...
                    {reviewer.username && (
                      <p className="text-sm text-gray-600 mb-3 ml-12 font-medium">
                        ...
                        <span className="ml-1 font-mono text-blue-600">@{reviewer.username}</span>
                      </p>
                    )}
                    ...
                    {reviewer.post && (
                      <p className="text-sm text-gray-600 mb-3 ml-12 font-medium">
                        <span className="text-gray-400">Post:</span> {reviewer.post}
                      </p>
                    )}

                    {reviewer.department && (
                      <p className="text-sm text-gray-600 mb-3 ml-12 font-medium">
                        <span className="text-gray-400">Department:</span> {reviewer.department}
                      </p>
                    )}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0461F0] focus:border-transparent disabled:bg-gray-100 disabled:text-gray-500 text-sm font-medium"
                      placeholder="username123"
                    />
                  </div>
                  {editingReviewer ? (
                    <p className="text-xs text-gray-500 mt-1.5 font-medium">Username cannot be changed</p>
                  ) : (
