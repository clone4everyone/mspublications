  ...
  return (
    ...
    <div>
      <div className='w-full h-[50px] flex justify-end items-center px-[101px] bg-[#1946DA]'>
        <div className='flex gap-8 text-white font-sans font-[400] text-[16px] leading-[100%] items-center'>
        ...
        {isAuthenticated ? (
          <div className="relative group">
            ...
            <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
...
<nav
      className={`relative z-30 px-4 sm:px-8 lg:px-[90px]  w-full h-[91px] sm:h-[89px] flex items-center justify-between
...
<button
  className="
    ...
    lg:h-[44px] lg:w-[162px] lg:px-0 lg:text-[15px]
    xl:h-[46px] xl:w-[162px] xl:text-[16px]
